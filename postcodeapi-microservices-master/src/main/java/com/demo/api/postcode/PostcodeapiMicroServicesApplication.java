...
public class PostcodeapiMicroServicesApplication implements CommandLineRunner{
	...
	public void run(String... strings) throws Exception {
		...
		records.add(new PostCodeRecord("3000", "MELBOURNE","VIC", "-1.126371", "52.640961"));
		records.add(new PostCodeRecord("3182", "ST KILDA WEST","VIC", "-1.166771", "51.640961"));
	    
		postCodeRepository.save(records);
		
		logger.info("Looking to load default post code...");
